...
import { Sparkles, Menu, X, User, LogOut, ChevronRight, Smartphone } from 'lucide-react';
    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-200/80 bg-white/90 backdrop-blur-xl shadow-xs">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3.5 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex items-center gap-2.5">
          ...
          {user ? (
            <div className="flex items-center gap-3 bg-slate-100 border border-slate-200 rounded-full pl-2 pr-3 py-1 shadow-xs">
              <img
                src={user.avatar}
                alt={user.name}
            ...
            <Link
              href="/auth/signin"
              className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-4 py-2 text-xs font-bold text-white shadow-md shadow-indigo-600/20 hover:from-indigo-700 hover:to-purple-700 transition-all active:scale-95"
            >
